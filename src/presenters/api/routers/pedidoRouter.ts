 ...
 *         schema:
 *           type: string
 *           enum: [Rascunho,Aguardando pagamento,Aguardando cancelamento pagamento, Falha em gerar pedido, Pedido cancelado, Aguardando preparo,Em preparo,Pronto,Entregue]
 *         required: false
